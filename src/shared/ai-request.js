...
export async function requestPreparedAi(preview, { allowTools = false, browserApi = browser, requestImpl = requestChatCompletion } = {}) {
  ...
  const toolCalls = allowTools ? (reply?.tool_calls || [])
