...
Для API-токена нужны права как минимум на чтение кластеров хранения, событий и используемых ресурсов. Экспорт расширенной схемы доступен администраторам и Tier 2 Analyst; при меньших правах ожидаем ответ `403`, остальные функции продолжат работать. Если используется внутренний сертификат, сначала откройте оба адреса в Firefox и подтвердите доверие сертификату.
