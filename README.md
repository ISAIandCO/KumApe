...
> [!IMPORTANT]
> Версия `0.1.2` — технический MVP для KUMA 4.6. Работа публичного REST API опирается на документацию KUMA и библиотеку `KUMA-Community/kapi`; private API нужно подтвердить на реальной инсталляции KUMA 4.6.
