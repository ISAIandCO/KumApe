...
> [!IMPORTANT]
> Версия `0.2.1` — технический preview для KUMA 4.6. Используемые REST-маршруты сверены с официальной схемой KUMA Public API 3.0; DOM и локальные mappings процессов всё ещё нужно проверить на реальной инсталляции.
...
- интерактивный граф процессов parent→child с force/timeline layout, zoom/pan, drag, поиском и фильтрами предков/потомков;
...
- граф сущностей расследования и объединение расследований между аналитиками;
